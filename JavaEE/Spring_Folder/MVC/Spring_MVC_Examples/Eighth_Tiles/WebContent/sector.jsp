 ...
 <script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#links').click(function(event) {
		        var homeid = $("#links").getAttribute("href");
		        alert(homeid);
		        $.ajax({
					type : "GET",
					
		 		url : "sector.do?homeid="+homeid,
					success : function(data){
							alert(data);

								  $('#links').html("<a href='tour.do?homeid=${data}'>");
...
<div class="header">
	...
	<div class="row">
      ...
      <div class="container">
      <div class="row">
<c:forEach var="images" items="${sectorlist}">
 <a id="links" href="tour.do?homeid=${images.homeid}">click</a><img src="<c:url value='${images.imagepath}'/>"  /><br>
</c:forEach>
